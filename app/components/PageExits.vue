<template>
  <div class="dash-card">
    ...
    <div v-else>
      <div v-for="(row, i) in rows" :key="i" class="flex items-center justify-between" :style="{ padding: '14px 0', borderBottom: i < rows.length - 1 ? '1px solid var(--dash-border-row)' : 'none' }">
