<template>
  <div class="dash-card">
    ...
    <div v-else>
      <div v-for="(loc, i) in locations" :key="i" class="flex items-center justify-between" :style="{ padding: '14px 0', borderBottom: i < locations.length - 1 ? '1px solid var(--dash-border-row)' : 'none' }">
